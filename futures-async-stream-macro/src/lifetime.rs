...
use syn::{
    ...
    Block, GenericArgument, Item, Lifetime, Receiver, Signature, TypeReference,
};

pub(crate) fn has_async_lifetime(sig: &mut Signature, block: &mut Block) -> bool {
...
pub(crate) struct CollectLifetimes {
    pub(crate) elided: Vec<Lifetime>,
    pub(crate) explicit: Vec<Lifetime>,
}

impl CollectLifetimes {
    pub(crate) fn new() -> Self {
        CollectLifetimes { elided: Vec::new(), explicit: Vec::new() }
    }
